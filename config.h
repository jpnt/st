...
/* for compatibility reasons i use xterm as the TERM variable */
char *termname = "xterm";
...
static Shortcut shortcuts[] = {
	...
	/* Ctrl+"+" to increment font size and Ctrl+"-" to decrement it */
	{ ControlMask, 		0x2b,		zoom,		{.f = +1} },
	{ ControlMask, 		0x2d,		zoom,		{.f = -1} },
	/* 0x2b is keysym of "+" and 0x2d is keysym of "-" */
